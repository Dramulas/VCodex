...
class StoreItemCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String weaponKey = weaponName != null
        ? weaponName.split(' ')[weaponName.split(' ').length - 1].toLowerCase()
        : '';

    double scaleValue = _weaponScaleValueMap[weaponKey] ??
        2.3; // eğer key map içinde yoksa 0.0 döndürü
