...
class AccountCard extends StatefulWidget {
  AccountCard({Key? key, required this.account, required this.index})
      : super(key: key);
  Account account;
  int index;
...
class _AccountCardState extends State<AccountCard> {
  ...
  showAlertDialog(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: const Text("Are you sure?", style: TextStyle(color: white)),
      actions: [
        cancelButton,
        deleteButton,
      ],
